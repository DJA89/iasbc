...
; Thu May 16 12:33:31 GMT+01:00 2019
; 
;+ (version "3.5")
;+ (build "Build 663")
...
(defrule PREPROCESS::requisitos-independientes
	...
	=>
	(modify ?requisitos (fibras 25000.0) (calcio 750.0 ) (potasio 3500.0) )
)
...
(defrule PREPARESOLUTION::preparar-soluciones-dia	
...
(defrule CREATESOLUTION::asignar-menuDiario
	?dia <- (dia ?numero-dia)
	?Sol-Dia <- (SolucionDia (dia ?y) )
	(test (and (eq ?numero-dia ?y) (< ?numero-dia 8) ))
	...
	?Comida <- (object (is-a Plato) (Calorias ?calorias2) (CarbohidratosTotales ?carbs2) (GrasaTotal ?gras2) (Proteinas ?prot2) (Calcio ?calcio2) (Potasio ?pot2) (FibrasAlimenticias ?fib2) (Tipo Principal))
	...
	?Cena <- (object (is-a Plato) (Calorias ?calorias4) (CarbohidratosTotales ?carbs4) (GrasaTotal ?gras4) (Proteinas ?prot4) (Calcio ?calcio4) (Potasio ?pot4) (FibrasAlimenticias ?fib4) (Tipo Principal))
...
=>
	...
	(printout t "Entrada a regla menu-dia para dia " ?y  crlf) ;Línea a borrar

	(if 	(and 
		(> ?carbsConsumido ?minCarbos) (< ?carbsConsumido ?maxCarbos)
		(> ?grasasConsumido ?minGrasas) (< ?grasasConsumido ?maxGrasas)
		(> ?protsConsumido ?proteinas) 
		(> ?fibrasConsumido ?fibras)
		(> ?calcioConsumido ?calcio)
		(> ?potasioConsumido ?potasio)
		) then

		(modify ?Sol-Dia (carbos ?carbsConsumido) (proteinas ?protsConsumido) (grasas ?grasasConsumido) (fibras ?fibrasConsumido) (potasio ?potasioConsumido) (calcio ?calcioConsumido)
				(desayuno ?Desayuno) (comida ?Comida) (postreComida ?PostreComida) (cena ?Cena) (postreCena ?Cena) )
		(assert (dia (+ ?numero-dia 1)) )
		(retract ?dia)
